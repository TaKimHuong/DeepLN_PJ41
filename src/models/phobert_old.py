...
PHOBERT_DIR = os.path.join(BASE_PATH, "checkpoints", "checkpoints_01")
...
if __name__ == "__main__":
    ...
    train_path = os.path.join(BASE_PATH, "data/data_01/processed/train.csv")
    val_path = os.path.join(BASE_PATH, "data/data_01/processed/val.csv")
